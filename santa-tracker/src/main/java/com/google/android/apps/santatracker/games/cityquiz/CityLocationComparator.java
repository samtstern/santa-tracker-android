...
public class CityLocationComparator implements Comparator<City> {
    ...
    public int compare(City c1, City c2) {
        double dist1 = SphericalUtil.computeDistanceBetween(city.getCorrectLocation(), c1.getCorrectLocation());
        double dist2 = SphericalUtil.computeDistanceBetween(city.getCorrectLocation(), c2.getCorrectLocation());
