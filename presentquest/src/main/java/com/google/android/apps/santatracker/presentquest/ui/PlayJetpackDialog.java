...
public class PlayJetpackDialog extends PlayGameDialog {
    ...
    public static final String EXTRA_LARGE_PRESENT = "extra_large_present";
    ...
    public void launchGame() {
        // TODO: Launch this more directly once code is merged
        Intent intent = new Intent("com.google.android.apps.santatracker.ACTION_JETPACK");
        intent.putExtra(EXTRA_LARGE_PRESENT, mPresentIsLarge);
