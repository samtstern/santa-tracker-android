...
public class PineappleLogEvent {
  ...
  public static final String SEARCH_CLICKED = "clicked search";
  public static final String SHARE_CLICKED = "clicked share";
  public static final String HOME_CLICKED = "clicked home";
  public static final String MENU_ITEM_CLICKED = "clicked menu item";
  ...
  public static final String JUMPING_GAME_TYPE = "jumping";
  public static final String BMX_GAME_TYPE = "bmx";
  public static final String RUNNING_GAME_TYPE = "running";
  public static final String TENNIS_GAME_TYPE = "tennis";
  public static final String WATERPOLO_GAME_TYPE = "waterpolo";
  public static final String GOLF_GAME_TYPE = "golf";
